...
-(void)initUI{
    ...
    UILabel *PV2Lable=[[UILabel alloc]initWithFrame:CGRectMake(85*NOW_SIZE, 16*HEIGHT_SIZE, 210*NOW_SIZE,28*HEIGHT_SIZE )];
    ...
    _detail2=[[UITextView alloc]initWithFrame:CGRectMake(10*NOW_SIZE,55*HEIGHT_SIZE, 300*NOW_SIZE,400*HEIGHT_SIZE)];
