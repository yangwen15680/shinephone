...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.unitLabel = [[UILabel alloc] initWithFrame:CGRectMake(5*NOW_SIZE, 10*NOW_SIZE, 100*NOW_SIZE, 30*NOW_SIZE)];
        self.unitLabel.font = [UIFont boldSystemFontOfSize:12*NOW_SIZE];
...
- (SHLineGraphView *)lineChartView {
    if (!_lineChartView) {
        ...
        if ([_frameType isEqualToString:@"1"]) {
            ...
            self.lineChartView = [[SHLineGraphView alloc] initWithFrame:CGRectMake(10*NOW_SIZE, 20*NOW_SIZE, 300*NOW_SIZE, 220*NOW_SIZE)];
            NSDictionary *_themeAttributes = @{
...
- (PNBarChart *)barChartView {
    if (!_barChartView) {
        self.barChartView = [[PNBarChart alloc] initWithFrame:CGRectMake(10*NOW_SIZE, 20*NOW_SIZE, 315*NOW_SIZE, 250*NOW_SIZE)];
