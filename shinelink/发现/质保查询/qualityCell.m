...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.name.font=[UIFont systemFontOfSize:14*NOW_SIZE];
        //self.name.text=@"逆变器";
        ...
        for (int i=0; i<_nameArray.count; i++) {
            ...
            nameLabel.font=[UIFont systemFontOfSize:10*NOW_SIZE];
        ...
        _alia.font=[UIFont systemFontOfSize:10*NOW_SIZE];
        ...
        _SN.font=[UIFont systemFontOfSize:10*NOW_SIZE];
      //  _SN.text=textArray[0];
        ...
        _beginTime.font=[UIFont systemFontOfSize:10*NOW_SIZE];
      //  _beginTime.text=textArray[0];
        ...
        _overTime.font=[UIFont systemFontOfSize:10*NOW_SIZE];
