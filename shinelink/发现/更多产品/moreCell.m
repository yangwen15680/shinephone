...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        self.connent = [[UITextView alloc] initWithFrame:CGRectMake(size2+imageSize+kongXi, size1+20*NOW_SIZE, 200*NOW_SIZE, 60*NOW_SIZE)];
        self.connent.font=[UIFont systemFontOfSize:12*NOW_SIZE];
